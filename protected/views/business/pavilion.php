        ...
        <div class="bottomArea">
            <div class="topmenu">
                <ul>
                    ...
                    <li><a id="myHeader2" href="javascript:showonlyone('newboxes2');">PUT SOMETHING ELSE HERE</a></li>
            ...
            <div id="newboxes1" class="newboxes">
                <div class="inside">
                    <h3>About Tom and Marty's Pub &amp; Restaurant</h3>
            ...
            <div id="newboxes3"class="newboxes"  style="display:none;">
                <div class="inside">
                    ...
                    <div class="boxes">
                        ...
                        <p><?php echo $model->companyHistory; ?></p>
                        <h3>Company Vision &amp; Mission </h3>
                        <p><?php echo $model->companyMission; ?></p>
                    </div>
                </div>
            </div>
        </div>
