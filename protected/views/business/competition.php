            ...
            <div id="newboxes1" class="newboxes">
                <div class="inside">
                    <div class="boxes">
                        ...
                        <h3>Specification</h3>
                        <ul class="inContent">
                            <li>Aenean vel adipiscing nisl. Sed nibh enim, tempus eu lacinia eu, posuere et eros. Fusce euismod placerat mauris, dignissim convallis sapien adipiscing ac. </li>
                            <li>Vivamus quis leo sem, eget semper orci. Quisque mattis augue vel purus volutpat volutpat. Cras ornare diam vel arcu tristique bibendum.</li>
                            <li> Maecenas ac lorem in tellus blandit feugiat in ut metus. Suspendisse et metus sed leo imperdiet semper id vel mauris. </li>
                            <li>Quisque vestibulum, dolor sed semper egestas, arcu mauris gravida elit, sed egestas sapien velit sit amet dui.</li>
                        </ul>
                    </div>
                </div>
            </div>
