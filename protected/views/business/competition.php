    ...
    <div class="fL">
        <div class="bottomArea innerMargin">
            <div class="topmenu">
                <ul>
                    <li><a href="#">All</a></li>
                    <li><a href="#">Local Competitions</a></li>
                    <li><a href="#">Global Competitions</a></li>
                    <li><a href="#">Map</a></li>
                </ul>
            </div>
            <div class="inside">
                            ...
                            <tr>
                                <td><table width="100%" cellpadding="0" cellspacing="1" class="listTable extra">
                                        <tr>
                                            ...
                                            <td><a href="#"><?php echo $competition->name . '<br>'; ?></a><br>
                                                <strong><?php echo $model->name . '<br>'; ?></strong><br>
                                                10 Challengers - None of your network <br>
                                                <em>Start Date: <?php echo $competition->startDate; ?> <br>
                                                    end Date: <?php echo $competition->endDate; ?></em></td>
