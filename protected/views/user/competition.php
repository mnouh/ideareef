<div id="InnerContent">
    ...
    <div class="fL">
        <div class="topArea">
            ...
            <div class="mid">
                <p><a href="#" class="post">Weekly Shot Wheel Competition </a><br>
            ...
            <div class="inside">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="1" class="listTable">
                                <tr>
                                    ...
                                    <td class="subscription"><span>153</span> <strong>Votes</strong><br>
                                        (+10 today) </td>
                                    <td class="stats"><a href="#">4th Place </a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="boxes">
                    <div class="bottom"> 
                        <table width="100%" cellpadding="0" cellspacing="1" class="listTable">
                            <tr>
                                <td colspan="4" class="paddL deep"><strong>Current Leaders </strong></td>
                            </tr>
                            <tr>
                                <td class="paddL"><a href="#">&quot;Cherry Bomb&quot;
                                    </a></td>
                                <td width="25" class="txtCenter">by</td>
                                <td><a href="#">Daniel Kopf </a></td>
                                <td class="right"><a href="#">(250)</a></td>
                            </tr>
                            <tr>
                                <td class="paddL"><a href="#">&quot;Da Bomb Daddy&quot; </a></td>
                                <td class="txtCenter">by</td>
                                <td><a href="#">Chris Plaquette </a></td>
                                <td class="right"><a href="#">(173)</a></td>
                            </tr>
                            <tr>
                                <td class="paddL"><a href="#">&quot;Animalistics&quot;</a></td>
                                <td class="txtCenter">by</td>
                                <td><a href="#">Jessica Albert </a></td>
                                <td class="right"><a href="#">(55)</a></td>
                            </tr>
                        </table>
                    </div></div>
                <div class="boxes">
                ...
                <p class="txtCenter"><a href="#" class="smBlueBtn" style="float:none; width:120px; margin:auto;">Submit another idea</a></p>
                <div class="clear"></div>
            </div>
        </div>
    </div>
