...
<div style="text-align:center !important; padding:10px 0px;"><img src="http://www.beta.ideareef.com/images/logo.png" alt="" width="261" height="54" /></div>
...
<div style="padding:15px; padding-top:60px; padding-bottom:0px;">
     ...
     <p>
         ...
         <a href="http://www.beta.ideareef.com/account/recover/?memberId=<?php echo $model->id; ?>&status=user&tok=<?php echo $model->verifyCode;?>">http://www.ideareef.com/account/recover/?memberId=<?php echo $model->id; ?>&tok=<?php echo $model->verifyCode;?></a>
     </p>
