...
<div style="padding:15px; padding-top:60px; padding-bottom:0px;">
     ...
     <p>
         ...
         <a href="http://localhost/~mnouh/ideareef/account/recover/?memberId=<?php echo $model->id; ?>&status=business&tok=<?php echo $model->verifyCode;?>">http://www.ideareef.com/account/recover/?memberId=<?php echo $model->id; ?>&tok=<?php echo $model->verifyCode;?></a>
     </p>
