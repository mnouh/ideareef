							...
							<td valign="top" style="padding: 0; margin: 0">
								...
								<tr>
									<td style="padding: 25px 0 0;" align="left">			
										<h2 style="color:#1d4272 !important; font-weight: normal; margin: 0; padding: 0; font-style: italic; line-height: 30px; font-size: 20px;font-family: Georgia, serif; "><singleline label="Title">Welcome <?php echo $model->firstName;?> to IdeaReef</singleline></h2>
									</td>
								</tr>
								<tr>
